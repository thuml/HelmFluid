...
def get_args():
    ...
    parser.add_argument('--file_path', default='real_1', type=str, help='real video folder')
    ...
    parser.add_argument('--z', default=1, type=int, help='input data depth')
    ...
    parser.add_argument('--z-down', default=1, type=int, help='width downsampe rate of input')
    parser.add_argument('--viscosity', default='1e-5', type=str, help='viscosity of dataset')
    ...
    parser.add_argument('--groups', default='8', type=int, help='number of groups for helmnet')
    ...
    # use-anylearn
    parser.add_argument('--anylearn', default=1, type=int, help='usage of anylearn')
    parser.add_argument('--pretrained_model', default='.', type=str, help='Pretrained models')
    parser.add_argument('--dataset_name', default='NS', type=str, help='Dataset name')
